...
Business logic for the watchlist feature (films a user wants to watch).
"""
...
def add_to_watchlist(user_id, film_id, public=True):
    ...
    Args:
        ...
        public (bool): Whether the entry is visible to others. Defaults to
            True — see the PR response (Comment 4) for the reasoning.
